...
export const pageContent = {
  ...
  'research/publications': {
    ...
    description: 'Research records and technical papers documented by our autonomous intelligence system with 43+ specialized research agents.',
    keywords: 'research records, technical papers, autonomous intelligence, scientific discovery',
    sections: [
      {
        type: 'hero',
        title: 'Research Publications',
        subtitle: 'Discover the latest research records and technical papers documented through our autonomous research systems.',
        stats: [
